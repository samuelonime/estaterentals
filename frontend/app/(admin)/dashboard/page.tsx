      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-800/60 overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-800">
            ...
            <Link href="/dashboard/properties" className="text-orange-500 text-sm hover:text-orange-600">View all →</Link>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-800/60 overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-800">
            ...
            <Link href="/dashboard/messages" className="text-orange-500 text-sm hover:text-orange-600">View all →</Link>
          </div>
          <div className="divide-y divide-slate-100 dark:divide-slate-800">
